...
def generate_training_data(display, clock):
    ...
    for _ in tqdm(range(training_games)):
        snake_start, snake_position, apple_position, score = starting_positions()# from game.py
        prev_apple_distance = apple_distance_from_snake(apple_position, snake_position)# from game.py
        ...
        for _ in range(steps_per_game):
            ...
            #calling to create snake at each step to update its presence.
